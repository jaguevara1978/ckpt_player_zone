(function(  ) {
     ...
     * Factory in the app.
     */
    angular.module( 'app' ).factory( 'FireworksService', FireworksService );

    function FireworksService( ) {
        /**
...
*/
         ...
         */
        function initialize( whereToPaint ) {
            ...
            // add the canvas in the whereToPaint element
            whereToPaint.appendChild( mainCanvas );
/*
